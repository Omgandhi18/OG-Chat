...
extension DatabaseManager{
    public func createNewConversation(with otherUserEmail: String, firstMesssage: Message,completion: @escaping(Bool) -> Void){
       ...
       ref.observeSingleEvent(of: .value, with: {
           ...
           if var conversations = userNode["conversations"] as? [[String:Any]]{
               ...
               ref.setValue(userNode,withCompletionBlock: {[weak self] error, _ in
                   ...
                   self?.finishCreatingConversation(converationID: conversationId, firstMessage: firstMesssage, completion: completion)
               })
    ...
    private func finishCreatingConversation(converationID: String, firstMessage: Message,completion: @escaping(Bool) -> Void){
